...
public class FutureValueApp {
    ...
    public static void main(String[] args) {
        ...
        while (choice.equalsIgnoreCase("y")) {
            ...
            printFormattedResults(sc,"Formatted Results",
    ...
    private static void printFormattedResults(Scanner sc, String prompt,
    			double monthlyInvestment, double interestRate, int years,
    			double futureValue) {
